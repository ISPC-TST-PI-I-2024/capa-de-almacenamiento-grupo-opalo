...
CREATE TABLE IF NOT EXISTS Paciente (
    ...
    altura DECIMAL(5, 2),
    correo VARCHAR(255),
    telefono VARCHAR(20)  -- Añadimos la columna telefono
);

-- Creación de la tabla Contacto_Emergencia
...
-- Creación de la tabla Dispositivo
CREATE TABLE IF NOT EXISTS Dispositivo (
    ...
    paciente_id INT,
    fabricante VARCHAR(255),  -- Añadimos la columna fabricante
    FOREIGN KEY (paciente_id) REFERENCES Paciente(paciente_id)
);
...
-- Ejemplos iniciales de inserción de datos
...
INSERT INTO Contacto_Emergencia (contacto_id, paciente_id, nombre, apellido, parentesco, direccion, telefono)
VALUES
    (1, 1, 'Ana', 'Pérez', 'Madre', 'Calle Principal 123', '+54 9 351 5060378'),
    (2, 2, 'Carlos', 'Rodríguez', 'Padre', 'Avenida Central 456', '+54 9 351 5060312');
...
INSERT INTO Dispositivo (dispositivo_id, modelo, fecha_fabricacion, fecha_colocacion, paciente_id, fabricante)
VALUES
    (1, 'Glucómetro A1', '2022-03-10 09:00:00', '2022-03-15 10:30:00', 1, 'Empresa X'),
    (2, 'Glucómetro B2', '2022-04-20 14:00:00', '2022-04-25 15:45:00', 2, 'Empresa Y');
